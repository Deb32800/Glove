...
// WiFi credentials
const char* ssid = "VINE";       // Replace with your WiFi SSID
const char* password = "0120095126";   // Replace with your WiFi password
...
void loop() {
  ...
  // Read flex sensors
  flexSensor(THUMB_PIN, "Thumb", "Right");
  flexSensor(INDEX_PIN, "Index", "Right");
  flexSensor(MIDDLE_PIN, "Middle", "Right");
  flexSensor(RING_PIN, "Ring", "Right");
  flexSensor(PINKY_PIN, "Pinky", "Right");

  // Read accelerometer and gyroscope
  accel_and_gyro("Right");
