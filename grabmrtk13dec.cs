...
public class grab : MonoBehaviour
{
    ...
    public Vector3 wristOffsetRotation = new Vector3(0, 0, 0);
    ...
    void Update()
    {
        ...
        {
            left_hand.transform.position = wristPose.Position;

            // Apply orientation offset
            Quaternion offset = Quaternion.Euler(wristOffsetRotation);
            left_hand.transform.rotation = wristPose.Rotation * offset;
        }
